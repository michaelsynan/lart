    ...
    <div class="relative flex flex-col items-center justify-start md:mt-0 mt-20 md:justify-center h-screen w-full">
      <section class="align-left w-full mb-0 md:mb-10">
        <div class="mx-auto w-full md:w-xl px-4">
          <h2 class="mb-4 text-5xl md:text-5xl tracking-tight font-extrabold text-left md:text-center text-white px-0 pb-3 md:px-4">Get In Touch</h2>
          <form action="#" class="space-y-6 text-lg">
            <div>
              <label for="email" class="block mb-2 text-gray-300 text-left font-bold">Email</label>
            ...
            <button type="submit"
              class="uppercase tracking-wide inline-flex justify-between w-full py-3 px-5 text-xl font-bold text-center text-white rounded-sm bg-primary-700  hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 bg-teal dark:focus:ring-primary-800">
